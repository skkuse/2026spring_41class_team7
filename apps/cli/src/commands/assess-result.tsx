...
export type AssessmentResultMeta = {
...
export default function AssessmentResultView({ result, meta }: Props) {
  ...
  return (
    <Box flexDirection="column" marginTop={1}>
      ...
      <Box flexDirection="column" borderStyle="round" borderColor="cyan" paddingX={2}>
        <Text bold color="cyan">JOBCLAW  ·  Node.js Backend Assessment</Text>
        <Box marginTop={1}>
