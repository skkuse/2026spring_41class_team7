      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {/* Subline */}
            <div style={{ fontSize: 16, color: 'rgba(50,25,10,0.45)', lineHeight: 1.5 }}>
            ...
            {['⚡ GitHub-powered', '🤖 AI Assessment', '🎯 Talent Directory'].map((label) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 4,
                  background: 'rgba(50,25,10,0.04)',
                  color: 'rgba(50,25,10,0.5)',
                  fontSize: 12,
                  fontWeight: 600,
        ...
        <div
          style={{
            width: 1,
            background: 'linear-gradient(to bottom, transparent, rgba(50,25,10,0.1) 20%, rgba(50,25,10,0.1) 80%, transparent)',
            flexShrink: 0,
          }}
        />
        ...
        >
          ...
          <div style={{ position: 'relative', width: 180, height: 180, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            >
              <span style={{ fontSize: 52, fontWeight: 800, color: '#1e120a', lineHeight: 1, letterSpacing: '-0.04em' }}>
                {SCORE}
              </span>
              <span style={{ fontSize: 13, color: 'rgba(50,25,10,0.38)', letterSpacing: '0.06em', fontWeight: 600, marginTop: 4 }}>
                / 100
              </span>
            </div>
          </div>

          <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(50,25,10,0.35)', textAlign: 'center' }}>
            Overall Score
          </div>
