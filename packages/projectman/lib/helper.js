...
// Jobclaw: store favorites next to ~/.jobclaw config (filename jobclaw-projects.json).
const SETTINGS_DIR =
  process.env.NODE_ENV === 'test'
    ? path.join(__dirname, '..', 'tests', 'dotjobclaw')
    : path.join(os.homedir(), '.jobclaw');

const SETTINGS_PATH = path.join(SETTINGS_DIR, 'jobclaw-projects.json');
...
// Takes data as input and writes that data to jobclaw-projects.json
